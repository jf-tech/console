...
func (a *ActionPerSecTicker) HowMany() int64 {
	...
	moves := int64(float64(a.clock.Now()-a.startTime) / float64(time.Second) * float64(a.aps))
...
func NewActionPerSecTicker(c *Clock, aps ActionPerSec, autoStart bool) *ActionPerSecTicker {
